...
def CR_CommandEntryError():
    print("При вводе команды была обнаружена ошибка: введена не верная команда (нет значения).")
    print("Попробуйте ввести ещё раз нужную команду или воспользуйтесь командой HELP для просмотра всех команд.")
    print()
